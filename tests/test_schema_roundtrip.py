...
SAMPLES = {
    ...
    IdentityRead: {
        ...
        "lora_uri": "s3://b/identities/owner/lora.safetensors",
        "created_at": utcnow(),
        "updated_at": utcnow(),
    },
    ConsentRecord: {"recorded_by": "karsten", "note": "self, on camera"},
    ShotCreate: {"idx": 0, "subject": "hands typing", "preset_ids": ["zoom_in"]},
    ShotRead: {
        "idx": 0,
        "subject": "hands typing",
        "preset_ids": ["zoom_in"],
        "id": _UUID,
        "storyboard_id": _UUID,
    },
